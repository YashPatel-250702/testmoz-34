...
Concepts in Aptitude: ${body.conceptName} (e.g., Quantitative Aptitude, Logical Reasoning, Verbal Ability, Data Interpretation), some times you will receive multiple concepts separated by commas.
...
Specifies the concepts being tested as ${body.conceptName}.
...
Align with the specified concepts ${body.conceptName} and complexity level ${body.complexity}.
...
Welcome to the aptitude test for this placement drive! This test assesses your skills in ${body.conceptName}. You have ${body.duration} minutes to complete ${body.numberOfQuestions} questions at ${body.complexity} level. Please read each question carefully, select the correct option for multiple-choice questions, and manage your time effectively. Good luck!
## Questions
- **Question 1**: [Concept: ${body.conceptName}] [Complexity: ${body.complexity}] [Question] [Options: A, B, C, D] [Correct Answer: X] [Expected Time: X minutes]
- **Question 2**: [Concept: ${body.conceptName}] [Complexity: ${body.complexity}] [Question] [Options: A, B, C, D] [Correct Answer: X] [Expected Time: X minutes]
...
- **Question ${body.numberOfQuestions}**: [Concept: ${body.conceptName}] [Complexity: ${body.complexity}] [Question] [Options: A, B, C, D] [Correct Answer: X] [Expected Time: X minutes]
Ensure the questions are varied, relevant to ${body.conceptName}, and appropriate for the ${body.complexity} level. Distribute questions across the specified concepts as evenly as possible. For multiple-choice questions, provide clear questions with four distinct answer options and specify the correct answer. Ensure the total estimated time aligns with ${body.duration}.
